...
Prism.languages.apl = {
  ...
  string: { pattern: /'(?:[^'\r\n]|'')*'/, greedy: !0 },
  number:
    /Â¯?(?:\d*\.?\d+(?:e[+Â¯]?\d+)?|Â¯|âˆž)(?:jÂ¯?(?:\d*\.?\d+(?:e[+Â¯]?\d+)?|Â¯|âˆž))?/i,
  statement: /:[A-Z][a-z][A-Za-z]*\b/,
  "system-function": { pattern: /âŽ•[A-Z]+/i, alias: "function" },
  constant: /[â¬âŒ¾#âŽ•âž]/,
  function:
    /[-+Ã—Ã·âŒˆâŒŠâˆ£|â³â¸?*âŸâ—‹!âŒ¹<â‰¤=>â‰¥â‰ â‰¡â‰¢âˆŠâ·âˆªâˆ©~âˆ¨âˆ§â±â²â´,âªâŒ½âŠ–â‰â†‘â†“âŠ‚âŠƒâŠ†âŠ‡âŒ·â‹â’âŠ¤âŠ¥â•âŽâŠ£âŠ¢ââ‚â‰ˆâ¯â†—Â¤â†’]/,
  "monadic-operator": { pattern: /[\\\/âŒ¿â€Â¨â¨âŒ¶&âˆ¥]/, alias: "operator" },
  "dyadic-operator": { pattern: /[.â£â â¤âˆ˜âŒ¸@âŒº]/, alias: "operator" },
  assignment: { pattern: /â†/, alias: "keyword" },
  punctuation: /[\[;\]()â—‡â‹„]/,
  dfn: { pattern: /[{}âºâµâ¶â¹âˆ‡â«:]/, alias: "builtin" },
};
...
Prism.languages.rest = {
  ...
  "list-bullet": {
    pattern:
      /(^\s*)(?:[*+\-â€¢â€£âƒ]|\(?(?:\d+|[a-z]|[ivxdclm]+)\)|(?:\d+|[a-z]|[ivxdclm]+)\.)(?= )/im,
    lookbehind: !0,
    alias: "punctuation",
  },
  "doctest-block": {
...
(Prism.languages["visual-basic"] = {
  comment: { pattern: /(?:['â€˜â€™]|REM\b).*/i, inside: { keyword: /^REM/i } },
  directive: {
    pattern:
